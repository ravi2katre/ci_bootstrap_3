...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2017 at 09:05 AM
...
(1, '127.0.0.1', 'webmaster', '$2y$08$/X5gzWjesYi78GqeAv5tA.dVGBVP7C1e1PzqnYCVe5s1qhlDIPPES', NULL, NULL, NULL, NULL, NULL, 'StLbqBF3j7FRHjJ3t45JCO', 1451900190, 1503336984, 1, 'Webmaster', ''),
...
INSERT INTO `menus` (`menu_id`, `parent_id`, `name`, `url`, `icon`, `children`) VALUES
(8, 0, 'Home', 'home', 'fa fa-home', ''),
(9, 0, 'Users', 'users', 'fa fa-users', ''),
(10, 0, 'Admin Panel', 'panel', 'fa fa-cog', ''),
(11, 0, 'Utilities', 'Utilities', 'fa fa-cogs', ''),
(12, 0, 'Sign Out', 'panel/logout', 'fa fa-sign-out', ''),
(13, 0, 'Database version', 'util/list_db', 'fa fa-circle-o text-aqua', '');
